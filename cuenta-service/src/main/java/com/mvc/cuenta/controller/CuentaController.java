...
public class CuentaController 
{
    ...
    @PutMapping("/{cuentaId}")
    public ResponseEntity<Cuenta> updateCuenta(@PathVariable Long cuentaId, @RequestBody Cuenta nuevaCuenta) 
    {
        Cuenta cuentaActualizada = cuentaService.updateCuenta(cuentaId, nuevaCuenta);
    ...
    {
        boolean eliminacionExitosa = cuentaService.deleteCuenta(cuentaId);
